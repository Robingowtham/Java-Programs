...
//		js.executeScript("arguments[0].click()", dresses);
		...
		createAccount.sendKeys("12341161xv1yy@gmail.com");

		WebElement button = driver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div/div/div[1]/form/div/div[3]/button/span"));
		button.click();
